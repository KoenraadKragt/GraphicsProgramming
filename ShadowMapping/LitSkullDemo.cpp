  ...
  mEyePosW(0.0f, 0.0f, 0.0f), mTheta(1.5f*MathHelper::Pi), mPhi(0.1f*MathHelper::Pi), mRadius(15.0f)
{
	...
	mSceneBounds.Radius = 1 * sqrtf(10.0f*10.0f + 15.0f*15.0f);
...
bool LitSkullApp::Init()
{
	...
	mShadowMap = new ShadowMap(md3dDevice, ShadowMapSize, ShadowMapSize);
	Effects::BasicFX->SetShadowMap(mShadowMap->DepthMapSRV());
...
void LitSkullApp::DrawSceneToShadowMap() {
...
void LitSkullApp::BuildShadowTransform()
{
